...
def webapp_add_wsgi_middleware(app):
    ...
    return app
"""
This is copied from the boilerplate default configuration file.
...
'locales' : ['en_US', 'es_ES', 'it_IT', 'zh_CN', 'id_ID', 'fr_FR', 'de_DE', 'ru_RU', 'nl_NL'],
...
'twitter_consumer_key' : 'cg7tV4ZGuFuEkIbksyXg',
'twitter_consumer_secret' : 'SAXKpE4v42zuSjlxugNDFeQEk3YPkv5Bo3G6IcvXcE',
...
'captcha_public_key' : "6LehktgSAAAAALh9VGCg7xh2tF5PQedEcGGCItMX",
'captcha_private_key' : "6LehktgSAAAAAEZNJA8uKaRin6sW_FLOzgwCH79-",

# Leave blank "google_analytics_domain" if you only want Analytics code
'google_analytics_domain' : "scrumuser.com",
